								...
								<div className="bg-white rounded-lg shadow-lg p-8">
									<div className="text-center mb-8">
										...
										<p className="text-gray-600">
											Share this QR code with your guests to allow them to
											register easily
										</p>
									</div>

									<div className="flex flex-col items-center gap-6">
										<div className="p-8 bg-white rounded-xl shadow-xl border-2 border-primary/20">
											<QRCodeSVG
												value={`${process.env.NEXT_PUBLIC_FRONTEND_URL}/${resorts?.resorts[0]?.id}/guests`}
												size={280}
												level="H"
												includeMargin={true}
												className="mx-auto"
											...
											<Button
												...
												onClick={() => {
													...
													img.onload = () => {
														...
														downloadLink.download = `guest-registration-${resorts?.resorts[0]?.name}.png`;
