			...
			<div className="mt-20">
				<div ref={homeSection.ref} className="prom-content" id="home">
					<div className="relative rounded-2xl w-full min-h-[400px] flex items-center justify-center">
						<div className="bg-prom-bg-image bg-no-repeat rounded-2xl bg-cover filter w-full h-[500px] brightness-75 shadow-md" />
						<div className="absolute space-y-5 px-4 text-center w-full max-w-[90%] md:max-w-[600px]">
							<Weather />
							<div className="space-y-2">
								<h1 className="font-bold text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-white tracking-wider leading-tight">
